        ...
        function renderInsightsPanel() {
            ...
            html += `
                <div class="p-4 bg-slate-50/50 rounded-2xl border border-slate-200 relative group overflow-hidden min-h-[128px]">
                    ...
                    <div class="flex items-start justify-between mb-2 relative z-10">
                        ...
                        <span class="text-[11px] font-bold uppercase tracking-wide text-slate-600">Velocity</span>
                    </div>
            ...
            html += `
                <div class="p-4 ${isRisk ? 'bg-rose-50/50 border-rose-200' : 'bg-emerald-50/50 border-emerald-200'} rounded-2xl border relative group overflow-hidden min-h-[128px]">
                    ...
                    <div class="flex items-start justify-between mb-2 relative z-10">
                        ...
                        <span class="text-[11px] font-bold uppercase tracking-wide ${isRisk ? 'text-rose-600' : 'text-emerald-700'}">Health</span>
                    </div>
                    <div class="relative z-10">
            ...
            html += `
                <div class="p-4 bg-slate-50/50 rounded-2xl border border-slate-200 relative group overflow-hidden min-h-[128px]">
                    ...
                    <div class="flex items-start justify-between mb-2 relative z-10">
                        ...
                        <span class="text-[11px] font-bold uppercase tracking-wide text-slate-600">MoM</span>
                    </div>
            ...
            html += `
                 <div class="p-4 bg-${runwayColor}-50/30 rounded-2xl border border-${runwayColor}-200 relative group overflow-hidden min-h-[128px]">
                    <div class="flex items-start justify-between mb-2 relative z-10">
                        <div class="bg-${runwayColor}-100 text-${runwayColor}-600 p-2 rounded-xl">
                            <i data-lucide="hourglass" class="w-4 h-4"></i>
                        </div>
                         <span class="text-[11px] font-bold uppercase tracking-wide text-${runwayColor}-700">Runway</span>
                    </div>
                    <div class="relative z-10">
                         ...
                         <p class="text-[11px] text-slate-600 mt-0.5">at current burn rate</p>
                    </div>
                </div>`;
            ...
            if (anomalies.length > 0) {
                 html += `
                <div class="col-span-1 sm:col-span-2 p-4 bg-purple-50/50 rounded-2xl border border-purple-200 relative group overflow-hidden">
                    <div class="flex items-center gap-2 mb-2">
                        <i data-lucide="alert-circle" class="w-4 h-4 text-purple-500"></i>
                        <span class="text-[11px] font-bold uppercase tracking-wide text-purple-700">Unusual Spend</span>
                    </div>
                    <div class="space-y-1">
                        ${anomalies.map(a => `
